...
public class Complaint extends AuditableAbstractAggregateRoot<Complaint> {
    ...
    TimelineItem t2 = new TimelineItem(this, "Under review", now, false, false, false);
    this.timeline.add(t2);

    // 3) Awaiting response (not current, not completed)
    TimelineItem t3 = new TimelineItem(this, "Awaiting response", now, false, false, false);
    this.timeline.add(t3);

    // 4) Rejected (not current, not completed)
    TimelineItem t4 = new TimelineItem(this, "Rejected", now, false, false, false);
    this.timeline.add(t4);

    // 5) Awaiting response (not current, not completed)
    TimelineItem t5 = new TimelineItem(this, "Completed", now, false, false, false);
