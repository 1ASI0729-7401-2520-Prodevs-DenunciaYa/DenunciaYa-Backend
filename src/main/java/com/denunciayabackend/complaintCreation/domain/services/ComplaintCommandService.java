...
public interface ComplaintCommandService {
    ...
    Complaint handle(UpdateTimelineItemCommand command);
    Complaint handle(AdvanceTimelineCommand command);
    Complaint handle(AcceptDecisionCommand command);
    Complaint handle(RejectDecisionCommand command);
